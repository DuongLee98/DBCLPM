...
public class CalculateFncTest {
    ...
    @Test
    public void testCalculatePrice6_1(){
        System.out.println("CalculatePrice");
        int total = 200;
        int[] arrLevelInp = {50, -50, 100, 100, 100, -1};
        int[] arrPriceInp = {1678, 1734, 2014, 2536, 2834, 2927};
        ...
        try {
            ...
            String expResult = "Wrong level<0 in arrayLevel index = 1";
            assertEquals(expResult, ex.getMessage());
        }
    }
    
    @Test
    public void testCalculatePrice6_2(){
        System.out.println("CalculatePrice");
        int total = 200;
        int[] arrLevelInp = {50, 50, -100, 100, 100, -1};
        int[] arrPriceInp = {1678, 1734, 2014, 2536, 2834, 2927};
        ...
        try {
            ...
            String expResult = "Wrong level<0 in arrayLevel index = 2";
            assertEquals(expResult, ex.getMessage());
        }
    }
    
    @Test
    public void testCalculatePrice6_3(){
        System.out.println("CalculatePrice");
        int total = 200;
        int[] arrLevelInp = {50, 50, 100, -100, 100, -1};
        int[] arrPriceInp = {1678, 1734, 2014, 2536, 2834, 2927};
        ...
        try {
            ...
            String expResult = "Wrong level<0 in arrayLevel index = 3";
            assertEquals(expResult, ex.getMessage());
        }
    }
    
    @Test
    public void testCalculatePrice6_4(){
        System.out.println("CalculatePrice");
        int total = 200;
        int[] arrLevelInp = {50, 50, 100, 100, -100, -1};
        int[] arrPriceInp = {1678, 1734, 2014, 2536, 2834, 2927};
        ...
        try {
            ...
            String expResult = "Wrong level<0 in arrayLevel index = 4";
            assertEquals(expResult, ex.getMessage());
        }
    }
    ...
    @Test
    public void testCalculatePrice7_1(){
        System.out.println("CalculatePrice");
        int total = 200;
        int[] arrLevelInp = {50, 50, 100, 100, 100, -1};
        int[] arrPriceInp = {1678, -1734, 2014, 2536, 2834, 2927};
        ...
        try {
            ...
            String expResult = "Wrong arrPrice<0 in arrPrice index = 1";
            assertEquals(expResult, ex.getMessage());
        }
    }
    
    @Test
    public void testCalculatePrice7_2(){
        System.out.println("CalculatePrice");
        int total = 200;
        int[] arrLevelInp = {50, 50, 100, 100, 100, -1};
        int[] arrPriceInp = {1678, 1734, -2014, 2536, 2834, 2927};
        ...
        try {
            ...
            String expResult = "Wrong arrPrice<0 in arrPrice index = 2";
            assertEquals(expResult, ex.getMessage());
        }
    }
    
    @Test
    public void testCalculatePrice7_3(){
        System.out.println("CalculatePrice");
        int total = 200;
        int[] arrLevelInp = {50, 50, 100, 100, 100, -1};
        int[] arrPriceInp = {1678, 1734, 2014, -2536, 2834, 2927};
        ...
        try {
            ...
            String expResult = "Wrong arrPrice<0 in arrPrice index = 3";
            assertEquals(expResult, ex.getMessage());
        }
    }
    
    @Test
    public void testCalculatePrice7_4(){
        System.out.println("CalculatePrice");
        int total = 200;
        int[] arrLevelInp = {50, 50, 100, 100, 100, -1};
        int[] arrPriceInp = {1678, 1734, 2014, 2536, -2834, 2927};
        ...
        try {
            ...
            String expResult = "Wrong arrPrice<0 in arrPrice index = 4";
            assertEquals(expResult, ex.getMessage());
        }
    }
    
    @Test
    public void testCalculatePrice7_5(){
        System.out.println("CalculatePrice");
        int total = 200;
        int[] arrLevelInp = {50, 50, 100, 100, 100, -1};
        int[] arrPriceInp = {1678, 1734, 2014, 2536, 2834, -2927};
        ...
        try {
            ...
            String expResult = "Wrong arrPrice<0 in arrPrice index = 5";
            assertEquals(expResult, ex.getMessage());
        }
    }
